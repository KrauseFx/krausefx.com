...
For example, having "[object HTMLMetaElement]" would mean an object, of the type
HTMLMetaElement is being used. However, there are no further insights on those.
...
HTMLDocument.createElement('meta')
  [object HTMLMetaElement].setAttribute
HTMLMetaElement.setAttribute('name', 'viewport')
  [object HTMLMetaElement].setAttribute
HIMLMetaElement.setAttribute('content', 'width=device-width')

HTMLDocument.getElementsByTagName('head')
[object HIMLCollection][0]
